...
User.create(first_name: "clyde", last_name: "gorceries", email: "test5@gmail.com", password: "password", is_host: true, city_id: 1)
...
Event.create(date: datetime.change(day: 4), address: "42nd St.",description: "See Hamilton", city_id: 2, host_id: 1)

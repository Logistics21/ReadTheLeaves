...
Event.create(date: datetime.change(day: 4), address: "Compton",description: "Straight Outta", city_id: city5.id, host_id: user3.id)
Event.create(date: datetime.change(day: 5), address: "Graceland",description: "Meet the King", city_id: city5.id, host_id: user3.id)
Event.create(date: datetime.change(day: 5), address: "Baker St.",description: "You're cryin' now", city_id: city5.id, host_id: user3.id)
Event.create(date: datetime.change(day: 5), address: "Get Tea",description: "It's London... what did you expect?", city_id: city6.id, host_id: user3.id)
Event.create(date: datetime.change(day: 5), address: "Buckingham Palace",description: "Visit Mum", city_id: city6.id, host_id: user3.id)
